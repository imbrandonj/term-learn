const MATHTERMS = {
  ...
  'f(x + h)': 'horizontal shift left',
  'f(x - h)': 'horizontal shift right',
  'af(x) where a > 1': 'vertical stretch',
  'af(x) where 0 < a < 1': 'vertical compression',
  'f(bx) where b > 1': 'horizontal compression',
  'f(bx) where 0 < b < 1': 'horizontal stretch',
  '-f(x)': 'x-axis reflection',
  'f(-x)': 'y-axis reflection',
  'Write the function rule for a vertical shift up.': 'f(x) + k',
  'Write the function rule for a vertical shift down.': 'f(x) - k',
  'Write the function rule for a horizontal shift to the left.': 'f(x + h)',
  'Write the function rule for a horizontal shift to the right.': 'f(x - h)',
  'Write the function rule for a vertical stretch.': 'af(x) a > 1',
  'Write the function rule for a vertical compression.': 'af(x) 0 < a < 1',
  'Write the function rule for a horizontal compression.': 'f(bx) b > 1',
  'Write the function rule for a horizontal stretch.': 'f(bx) 0 < b < 1',
  'Write the function rule for a reflection over the x-axis.': '-f(x)',
  'Write the function rule for a reflection over the y-axis.': 'f(-x)',
  'Which function transformation changes x-values?': 'horizontal shift',
  'Which function transformation changes y-values?': 'vertical shift',
  'Transformations inside the function affect...': 'x values',
  'Transformations outside the function affect...': 'y values',
